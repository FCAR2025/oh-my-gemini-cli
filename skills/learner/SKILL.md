...
> Deprecated compatibility alias: use `/omg:skillify` for new skill extraction workflows. This file remains for internal implementation/history and compatibility.

This is a self-improving skill. It has two distinct sections:
...
- /omg:skillify - Turn a repeatable workflow into a reusable OmG skill draft
